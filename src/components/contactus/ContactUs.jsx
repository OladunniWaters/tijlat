  ...
  return (
      <div className='contact'> 
           ...
           <div className='contact_cont'>      
                <div data-aos="fade-right" data-aos-offset="400" data-aos-duration="1500" className='contact_image_cont'>
                   <img src={contactImage} alt='tijlat_contactus_image' className='contactus_image'/>
               </div> 
                
                
                <div data-aos="fade-left" data-aos-offset="400" data-aos-duration="1500" className='contact_content_cont'>
